    ...
    var YC = {/*本地控制版本号*/
        ...
        * */
        template: {
            ...
            getGift: function(){
                /**
                 * <div class="gift-item msg-in-out">
                 *  <img class="gift-header-img" src="image/gift/kiss.png"/>
                 *  <div class="gift-info">
                 *      <p class="color-ffdb35 text-warp">杨超-第一桌</p>
                 *      <p class="color-2ed0d6">玫瑰花</p>
                 *  </div>
                 *  <div class="gift-goods animated bounceInLeft delay-1">
                 *      <img src="image/gift/kiss.png" class="gift-img"/>
                 *      <em class="gift-num animated bounceIn delay-2">x1</em>
                 *  </div>
                 * </div>
                 * */
                /*模拟不同礼物*/
                var gifts = [{
                    name:'掌声',
                    src:'image/gift/applause.png'
                },{
                    name:'干杯',
                    src:'image/gift/cheers.png'
                },{
                    name:'果盘',
                    src:'image/gift/compote.png'
                },{
                    name:'法拉利',
                    src:'image/gift/ferrari.png'
                },{
                    name:'我喜欢你',
                    src:'image/gift/love.png'
                },{
                    name:'吻',
                    src:'image/gift/kiss.png'
                },{
                    name:'兰博基尼',
                    src:'image/gift/lamborghini.png'
                },{
                    name:'再来一首',
                    src:'image/gift/onemoresong.png'
                },{
                    name:'红包',
                    src:'image/gift/redpack.png'
                },{
                    name:'玫瑰花',
                    src:'image/gift/rose.png'
                },{
                    name:'星中歌喉',
                    src:'image/gift/starvoice.png'
                },{
                    name:'奖杯',
                    src:'image/gift/trophy.png'
                },{
                    name:'游艇',
                    src:'image/gift/yacht.png'
                }];
                var num = parseInt(13* Math.random());
                var gift = gifts[num];
                var html = '<div class="gift-item msg-in-out">'+
                    '<img class="gift-header-img" src="image/gift/applause.png"/>'+
                    '<div class="gift-info">'+
                    '<p class="color-ffdb35 text-warp">杨超-第一桌</p>'+
                    '<p class="color-2ed0d6">'+gift.name+'</p>'+
                    '</div>'+
                    '<div class="gift-goods animated bounceInLeft delay-1">'+
                    '<img src="'+gift.src+'" class="gift-img"/>'+
                    '<em class="gift-num animated bounceIn delay-2">x1</em>'+
                    '</div>'+
                    '</div>';
                return html;
